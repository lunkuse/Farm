...
class Edit extends Component
{
    ...
    public function mount(ManageEctoParasite $manageEctoParasite)
    {
        ...
        $this->block              = $this->manageEctoParasite->block()->pluck('id')->toArray();
        $this->acaricide_used     = $this->manageEctoParasite->acaricideUsed()->pluck('id')->toArray();
        $this->initListsForFields();
    }

    public function render()
    {
        return view('livewire.manage-ecto-parasite.edit');
    }
