...
class Edit extends Component
{
    ...
    public function mount(ManageHealthRecord $manageHealthRecord)
    {
        ...
        $this->clinical_history       = $this->manageHealthRecord->clinicalHistory()->pluck('id')->toArray();
        $this->current_diagnosis      = $this->manageHealthRecord->currentDiagnosis()->pluck('id')->toArray();
        $this->treatment_administered = $this->manageHealthRecord->treatmentAdministered()->pluck('id')->toArray();
        $this->initListsForFields();
    }

    public function render()
    {
        return view('livewire.manage-health-record.edit');
    }
