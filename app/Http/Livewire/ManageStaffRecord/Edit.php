...
class Edit extends Component
{
    ...
    public function mount(ManageStaffRecord $manageStaffRecord)
    {
        ...
        $this->role              = $this->manageStaffRecord->role()->pluck('id')->toArray();
        $this->recommendation    = $this->manageStaffRecord->recommendation()->pluck('id')->toArray();
        $this->initListsForFields();
    }

    public function render()
    {
        return view('livewire.manage-staff-record.edit');
    }
