...
class Edit extends Component
{
    ...
    public function mount(ManageSaleRecord $manageSaleRecord)
    {
        ...
        $this->animal_tag       = $this->manageSaleRecord->animalTag()->pluck('id')->toArray();
        $this->sale_purpose     = $this->manageSaleRecord->salePurpose()->pluck('id')->toArray();
        $this->initListsForFields();
    }

    public function render()
    {
        return view('livewire.manage-sale-record.edit');
    }
